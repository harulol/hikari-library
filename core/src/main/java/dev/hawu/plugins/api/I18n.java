...
public final class I18n {
     ...
     * present in {@link Constants}.
     *
     * @since 1.2
     */
    public I18n() {
        Constants.getPlugin().saveResource("messages.yml", false);
        this.messagesFile = new File(Constants.getPlugin().getDataFolder(), "messages.yml");
        this.messages = YamlConfiguration.loadConfiguration(this.messagesFile);
        this.defaultMessages = YamlConfiguration.loadConfiguration(new InputStreamReader(Constants.getPlugin().getResource("messages.yml")));
    }
