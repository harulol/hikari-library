...
public final class CommandArgument {
     ...
     * @since 1.0
     */
    public CommandArgument(@NotNull final String @NotNull [] strings) {
     ...
     * @since 1.0
     */
    public CommandArgument(@NotNull final List<@NotNull String> strings) {
        this.args = strings;
    }
     ...
     */
    @NotNull
    public List<@NotNull String> getUnderlyingList() {
        return args;
    }
     ...
     */
    @NotNull
    public Pair<@NotNull CommandArgument, @NotNull Map<@NotNull String, @NotNull List<@NotNull String>>> parse() {
     ...
     */
    @NotNull
    public List<@NotNull String> slice(final int startInclusive, final int endExclusive) {
