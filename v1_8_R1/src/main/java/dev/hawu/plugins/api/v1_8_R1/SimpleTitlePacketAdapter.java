...
public final class SimpleTitlePacketAdapter extends TitlePacketAdapter {
    ...
    public void send(final @NotNull Player player, final @NotNull TitleComponent component) {
        ...
        final Packet title = new PacketPlayOutTitle(EnumTitleAction.TITLE, wrap(component.getTitle()));
        final Packet subtitle = new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, wrap(component.getSubtitle()));
    ...
    public void clear(final @NotNull Player player) {
        final Packet packet = new PacketPlayOutTitle(EnumTitleAction.CLEAR, EMPTY);
        sendPacket(player, packet);
    }
